...
/* number functions */
amf0_data * amf0_number_new(double value);
double   amf0_number_get_value(amf0_data * data);
void       amf0_number_set_value(amf0_data * data, double value);
...
/* date functions */
amf0_data * amf0_date_new(double milliseconds, int16_t timezone);
double amf0_date_get_milliseconds(amf0_data * data);
